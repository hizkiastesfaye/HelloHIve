...
void main(){
  ...
  test('should check if the device is online', () async{
    ...
    when(mockRemoteDataSource.signInRemoteDataSource(any))
      .thenAnswer((_) async => tAuthModels);
    //act
    repositories.signInRepository(tparams);
    //assert
  ...
  group('sign in repository test', (){
    test('should return AuthEntities when call to remote data source is successful', () async{
      ...
      //act
      final result = await repositories.signInRepository(tparams);
      print('--------------------------------------');
      print('--- $result ----');
      print('--------------------------------------');
      //assert
      verify(mockRemoteDataSource.signInRemoteDataSource(tparams));
