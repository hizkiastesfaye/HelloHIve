...
void main(){
  ...
  test('should delete user profile if successful',() async{
    //arrange
    getSetup();
    when(mockUserProfileRemote.deleteUserProfileRemote(any))
    .thenAnswer((_) async=> unit);

    //act
    final result = await userProfileRepoImpl.deleteUserProfileRepo(tUserProfParams);

    //assert
    verify(mockUserProfileRemote.deleteUserProfileRemote(any));
    expect(result, Right(unit));
  });

    test('should return NetworkFailure when call to delete remote data source',() async{
    //arrange
  ...
  test('should return ServerFailure when to call delete remote data source is unsuccessful', () async{
    getSetup();
    when(mockUserProfileRemote.deleteUserProfileRemote(any))
